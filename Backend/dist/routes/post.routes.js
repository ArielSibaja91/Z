...
router.post("/like/:id", protectRoute_1.protectRoute, post_controller_1.likePost);
router.post("/comment/:id", protectRoute_1.protectRoute, post_controller_1.commentPost);
